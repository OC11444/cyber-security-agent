...
export const canisterId = process.env.CANISTER_ID_LOG_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./log_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the log_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./log_canister.did.js")._SERVICE>}
 */
export const log_canister = createActor(canisterId);
